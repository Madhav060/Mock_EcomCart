...
A full-stack shopping cart application built with React, Redux, Node.js, Express, MongoDB, and **Tailwind CSS**.
...
# Setup environment variables (edit .env if using MongoDB Atlas)
# Default: mongodb://localhost:27017/ecom-cart
